<div class="form-group">
    ...
    <input type="password" name="params[token]" id="params_token" class="form-control" value="" required>
</div>

<div class="form-group">
    <label for="params_header">Header Name</label>
    <input type="text" name="params[header]" id="params_header" class="form-control" value="Authorization" required>
...
<div class="form-group">
    ...
    <input type="text" name="params[scheme]" id="params_scheme" class="form-control" value="Bearer">
