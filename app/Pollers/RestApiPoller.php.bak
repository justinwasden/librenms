...
class RestApiPoller
{
    ...
    {
        // Use MetricStorageEngine to store data using mapper's logic
        $storageEngine = new MetricStorageEngine($device);
        $storageEngine->storeFromResponse($response, $endpoint, $mapper);
    }
